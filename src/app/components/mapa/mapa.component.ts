...
// cuando creo un componente y hay mas de un modulo tengo que especificar en que modulo quiero importar el componente
// entonces: ng g c components/Nombre --module=app.module
